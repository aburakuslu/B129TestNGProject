...
public class C02_PageKullanimi {
    ...
    public void test1() {
        ...
        /*
         Yukardaki adress için 20 adet test methodu oluşturursak,
         sonrasında yukardaki url'de bir değişiklik olduğunda
         bütün test methodlarından tek tek url düzeltmek yerine bir kere .properties dosyamdan
